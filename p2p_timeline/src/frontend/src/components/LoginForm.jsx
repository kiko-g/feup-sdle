  ...
  return (
    <div className="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div>
          <img className="mx-auto h-20 w-20 border-2 rounded-full bg-sky-600" src={logo} alt="icon" />
          <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">Sign in to your account</h2>
          <p className="mt-2 text-center text-sm text-gray-600">
            Or <button className="font-medium text-sky-600 hover:text-sky-500">register on the platform</button>
          </p>
        </div>
        <form className="mt-8 space-y-6" action="#" method="POST">
          ...
          <div className="hidden">
            ...
            <div className="text-sm">
              <button className="font-medium text-sky-600 hover:text-sky-500">Forgot your password?</button>
            </div>
          </div>
